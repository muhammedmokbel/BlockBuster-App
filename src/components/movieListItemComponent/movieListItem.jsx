...
const MovieListItem = ({poster_path , first_air_date , original_title , overview , media_type, release_date , vote_average}) => (
    <div class="movie-item-style-2">
        <img src={poster_path} alt="" />
        <div class="mv-item-infor">
            <h6><a href="moviesingle.html">{original_title} <span>({release_date && release_date.split('-')[0] || first_air_date && first_air_date.split('-')[0]})</span></a></h6>
